...
class Configuration(tk.Frame):
    ...
    def save_current_config(self):
        ...
        if self.image_orientation == '0':
           ...
           orientation = 3  
        text_in_file = "Raw Directory:\n{}\nScratch Directory:\n{}\nInitial Run:\n{}\nPLC temperature var:\n{}\nRelative Path to images:\n{}\nImage naming convention(0 for 'cam0_image0.png', 1 for 'cam0image  0.bmp'):\n{}\nNumber of Cameras:\n{}\nImage Orientation (0 for '0', 1 for '90', 2 for '180', 3 for '270'):\n{}\nfirst frame:\n{}\ntrig frame:\n{}\nlast frame:\n{}\nPiezo:\n{}\nDytran:\n{}\nJar - Radius (mm):\n{}\nJar - Positive Z Height (mm):\n{}\nJar - Negative Z Height (mm):\n{}\nReco Directory:\n{}\nHandscan Directory:\n{}".format(self.raw_init_directory, os.path.dirname(self.extraction_path), self.init_run, self.plc_temp_var, self.images_relative_path, image_convention, self.num_cams, orientation, self.first_frame, self.init_frame, self.last_frame, self.piezo, self.dytran, self.radius, self.positive_z, self.negative_z, self.reco_directory, self.scan_directory)
